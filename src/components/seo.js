  ...
  return (
    ...
    >
      ...
      <script
        ...
        data-modal-disclaimer="This is an experimental generative AI chatbot trained on public documentation,  github repository, and other content. Feel free to ask anything about Milvus and Zilliz Cloud! "
        data-modal-example-questions="Get Started with Milvus,Learn more about embeddings?,What's new in Milvus 2.4?,What is the difference between search() and query() in Milvus?,How do I register for Zilliz Cloud - try managed Milvus?"
