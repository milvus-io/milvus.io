# rest-specs-rendering Specification

## Purpose

Defines how the milvus.io REST spec viewer renders OpenAPI-style specs, including multi-option schema/example tab synchronization, localization via `x-i18n`, enum and admonition rendering, and curl example generation, while preserving milvus.io-specific behavior.
